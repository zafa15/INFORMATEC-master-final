...
public class CategoriaActivity_Adapter extends RecyclerView.Adapter<CategoriaActivity_Adapter.ProductViewHolder> {

    private Context mCtx;
    private List<CategoriaProduct> productList;

    public CategoriaActivity_Adapter(Context mCtx, List<CategoriaProduct> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public CategoriaActivity_Adapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.activity_procesadores_list, null);
        return new CategoriaActivity_Adapter.ProductViewHolder(view);
    }
    @Override
    public void onBindViewHolder(CategoriaActivity_Adapter.ProductViewHolder holder, int position) {
